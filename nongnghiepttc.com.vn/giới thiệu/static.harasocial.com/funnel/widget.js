!(function (global, factory) {
  ...
  if (typeof module === "object" && typeof module.exports === "object") {
    module.exports = global.document
      ...
      : function (w) {
          if (!w.document) {
            throw new Error(
              "harafunnel widget requires a window with a document"
            );
          }
  ...
  function fw1(a, p, w, c, cces) {
    ...
    var interval = setInterval(function () {
      ...
      if (fbDialog && fbDialog.length > 0) {
        ...
        fbDialog[0].innerHTML =
          '<img src="//static.harasocial.com/svg-funnel/ic_messenger_logo.png" style="position:fixed;bottom:50px;right:30px;cursor:pointer;" height="60" width="60" alt="" class="img">';
  ...
  if (window.hasOwnProperty("hrfwidget")) {
    ...
    if (
      js != undefined &&
      js != null &&
      js.hasOwnProperty("appId") &&
      js.hasOwnProperty("pageId") &&
      js.hasOwnProperty("widgets")
    ) {
      var appId = js["appId"];
      ...
      if (lstCustomerChat?.length) {
        lstCustomerChat.forEach((w) => {
          var t = w["type"];
          if (t === "customer_chat") {
            var index = customer_chats
              .map(function (a) {
                return a.growthtool_id;
              })
              .indexOf(w["id"]);
            var c = null;
            if (index > -1) c = customer_chats[index];
