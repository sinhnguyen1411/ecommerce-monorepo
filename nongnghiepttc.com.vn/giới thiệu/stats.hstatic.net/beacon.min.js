!(function () {
  ...
  (n.g = (function () {
    ...
    (function () {
      ...
      var e,
        t = function (e, t, n) {
          var r = { value: t, expiry: new Date().getTime() + 60 * n * 1e3 };
      ...
      function g() {
        return p || (((p = r(v)) && p.id) || (p = { id: h() }), t(v, p, f), p);
      }
      var y,
        _ = "hrvBeacon_s";
      function b(e) {
        ...
        if (n) {
          ...
          r || (n.events.push({ event: e, state: y.track }), t(_, n, 30));
        }
      }
      function k() {
        var e,
          ...
          o = !1;
        if (
          ((e = null == i ? void 0 : i.campaign),
          !(n = w()) ||
            ((null == e ? void 0 : e.utm_source) ===
              (null == n ? void 0 : n.utm_source) &&
              (null == e ? void 0 : e.utm_medium) ===
                (null == n ? void 0 : n.utm_medium) &&
              (null == e ? void 0 : e.utm_campaign) ===
                (null == n ? void 0 : n.utm_campaign) &&
              (null == e ? void 0 : e.utm_term) ===
                (null == n ? void 0 : n.utm_term) &&
              (null == e ? void 0 : e.utm_content) ===
                (null == n ? void 0 : n.utm_content)) ||
            (o = !0),
          (!i || o) && ((i = { sessionId: h(), campaign: w() }), (o = !0)),
          o)
        ) {
          var a = { event: "startSession", state: y.track };
        ...
        if (e.AutoTrack && e.ga4) {
          ...
          if (n || e.enhancedEcommercev4) {
            ...
            "product" == t.pageType
              ...
              : "ajaxUpdateCart" == t.pageType
              ? (function (e) {
                  r(e, "remove_from_cart");
                })(t)
              : "checkout" == t.pageType
              ? t.properties.cartToken
                ? o(t)
                : (function (e) {
                    var t,
                      r = e.products,
                ...
                (t.properties.cartToken
                  ...
                  : (function (e) {
                      var t,
                        ...
                        v = e.properties,
                        f =
                          null === (t = null == v ? void 0 : v.orderId) ||
                          void 0 === t
                            ? void 0
                            : t.toString(),
      ...
      function S(e, t) {
        if (e.AutoTrack && e.tt) {
          ...
          if (n && t) {
            ...
            n.track("AddToCart", {
              content_ids: r ? [r] : [],
              content_type: t.properties.variantId
                ? "product"
                : "product_group",
              contents: [
                {
      ...
      function A(e, t, n, r, i, o) {
        if (null != n && -1 != n.url.indexOf("/cart/add")) {
          if (null != t && t.responseJSON) {
            ...
            (s.id = a.product_id),
              ...
              (function (e, t) {
                    ...
                    ("product" == t.pageType
                      ...
                      ? t.properties.cartToken
                        ...
                        : (function (e) {
                            ...
                            n("ec:setAction", "checkout", { step: 1 }), a(e);
                          })(t)
                      : "thankyou" == t.pageType &&
                        (t.properties.cartToken
                          ? i(t)
                ...
                function r(e) {
                  var t = e.options_GA;
                  t.enhancedEcommerceLoaded ||
                    (n("require", "ec"), (t.enhancedEcommerceLoaded = !0)),
                    n("set", "&cu", e.properties.currency);
                }
                function i(e) {
                  var t = e.properties,
          ...
          ((null != n && -1 != n.url.indexOf("/cart/update")) ||
            (null != n && -1 != n.url.indexOf("/cart/change")) ||
            (null != n && -1 != n.url.indexOf("/cart/clear"))) &&
            null != t &&
            t.responseJSON &&
            ((a = t.responseJSON),
      ...
      var C,
        ...
        O = {
          ...
          properties: {
            ...
            currency:
              null === (C = null == L ? void 0 : L.meta) || void 0 === C
                ? void 0
                : C.currency,
          },
          carts: {
          ...
          options_GA: {
            ...
            enhancedEcommercev4:
              (null == L ? void 0 : L.enhancedEcommercev4) || !1,
            ...
            L &&
              (function (e) {
                var n,
                  ...
                  c,
                  u =
                    null === (n = L.meta.page) || void 0 === n
                      ? void 0
                      : n.pageType;
                if (u) {
                  if (((O.pageType = u), "thankyou" == O.pageType))
                    e.userId =
                      null ===
                        (o =
                          null === (i = P.Haravan) || void 0 === i
                            ? void 0
                            : i.checkout) || void 0 === o
                        ? void 0
                        : o.customer_id;
                  ...
                  var p = new URLSearchParams(window.location.search).get(
                    "ref_f4l"
                  );
                  switch ((p && m({ ref_f4l: p }), O.pageType)) {
                    case "cart":
                      break;
                    case "product":
                      !(function (e, t, n) {
                        ...
                        if (r) {
                          (n.properties.id = r.id),
                            r.selected_or_first_available_variant
                              ? ((n.properties.name =
                                  r.selected_or_first_available_variant.title),
                                (n.properties.variantId =
                                  r.selected_or_first_available_variant.id),
                                (n.properties.variant =
                                  r.selected_or_first_available_variant.variant_title),
                                (n.properties.price =
                                  r.selected_or_first_available_variant.price /
                                  100),
                                (n.properties.sku =
                                  r.selected_or_first_available_variant.sku))
                              : ((n.properties.title = r.title),
                      ...
                      !(function (e, n, i) {
                        ...
                        if (u && u.checkout) {
                          ...
                          s.line_items.forEach(function (e) {
                            ...
                            l.push(r),
                              0 == p.includes(e.product_id) &&
                                p.push(e.product_id),
                              "" === e.variant_id ||
                                null === e.variant_id ||
                                void 0 === e.variant_id ||
                                d.includes(e.variant_id) ||
                                d.push(e.variant_id),
                              (v += e.quantity);
                          }),
                            (i.products = l),
                            (i.properties.arrProductId = p),
                            (i.properties.arrVariantId = d),
                            (i.properties.coupon =
                              (null === (o = s.discount) || void 0 === o
                                ? void 0
                                : o.code) || ""),
                            (i.properties.orderId = s.order_number),
                            (i.properties.shipping =
                              (null === (a = s.shipping_rate) || void 0 === a
                                ? void 0
                                : a.price) || 0),
                            (i.properties.subtotal_price = s.subtotal_price),
                            (i.properties.total_price = s.total_price),
                            (i.properties.quantity = v),
                            (i.properties.event = "Completed Order"),
                            r("__hrv_tracked_start_checkout") == s.token
                              ? t("__hrv_tracked_start_checkout", "", 129600)
                              : (i.properties.cartToken = !0);
                          var f = { purchase: u.checkout };
                          (null === (c = null == i ? void 0 : i.properties) ||
                          void 0 === c
                            ? void 0
                            : c.cartToken) ||
                            (b("Purchase"), e.send("Purchase", f));
                        }
                      })(e, L, O);
                      break;
                    case "checkout":
                      !(function (e, n, i) {
                        ...
                        if (a && c) {
                          ...
                          a.products.forEach(function (e) {
                            ...
                            p.push(r),
                              0 == u.includes(e.productId) &&
                                u.push(e.productId),
                              "" === e.variantId ||
                                null === e.variantId ||
                                void 0 === e.variantId ||
                                s.includes(e.variantId) ||
                                s.push(e.variantId);
                          }),
                            (i.products = p),
                            (i.properties.arrProductId = u),
                            (i.properties.arrVariantId = s),
                            (i.properties.quantity = a.item_count),
                            (i.properties.total_price = a.total_price / 100),
                            (i.properties.event = "Viewed Checkout"),
                            r("__hrv_tracked_start_checkout") != c.resourceId ||
                            "" == r("__hrv_tracked_start_checkout") ||
                            null == r("__hrv_tracked_start_checkout") ||
                            "undefined" == r("__hrv_tracked_start_checkout")
                              ? t(
                                  "__hrv_tracked_start_checkout",
                                  c.resourceId,
                                  129600
                                )
                              : (i.properties.cartToken = !0);
                        }
                        var d = { cart: n.meta.cart };
                        (null === (o = null == i ? void 0 : i.properties) ||
                        void 0 === o
                          ? void 0
                          : o.cartToken) ||
                          (b("InitiateCheckout"),
                          e.send("InitiateCheckout", d));
                      })(e, L, O);
                  }
                  L.ga4 &&
                    (function (e, t, n) {
                      if (t.AutoTrack && t.ga4) {
                        ...
                        r &&
                          n &&
                          n.options_GA.enhancedEcommercev4 &&
                          (n.options_GA.doubleClick &&
                            r("require", "displayfeatures"),
                          n.options_GA.enhancedLinkAttribution &&
                            r("require", "linkid"),
                          n.options_GA.anonymizeIp &&
                            r("set", "anonymizeIp", n.options_GA.anonymizeIp),
                          n.options_GA.enhancedEcommercev4 && T(t, n));
                      }
                    })(0, L, O),
                    L.fb &&
                      (function (e, t, n) {
                        if (t.AutoTrack && t.fb) {
                          ...
                          r &&
                            ...
                            "product" == n.pageType
                              ...
                              : "searchresults" == n.pageType
                              ? r("track", "Search", {
                                  search_string: n.properties.keySearch,
                                })
                              : "thankyou" == n.pageType
                              ? (r("track", "AddPaymentInfo", {
                          ...
                          if (u && n) {
                            var s =
                                null !==
                                  ...
                                  : [],
                              p =
                                (null === (o = n.properties.arrVariantId) ||
                                void 0 === o
                                  ? void 0
                                  : o.length) > 0
                                  ? n.properties.arrVariantId
                                  : null !== (a = n.properties.arrProductId) &&
                                    void 0 !== a
                                  ? a
                                  : [],
                              d =
                                (null === (c = n.properties.arrVariantId) ||
                                void 0 === c
                                  ? void 0
                                  : c.length) > 0
                                  ? "product"
                            ...
                            if ("product" == n.pageType) {
                              ...
                              u.track("ViewContent", {
                                content_ids: l ? [l] : [],
                                content_type: n.properties.variantId
                                  ? "product"
                                  : "product_group",
                                contents: [
                                  {
                                    ...
                                    content_name:
                                      n.properties.name ||
                                      ""
                                        .concat(n.properties.title, " - ")
                                        .concat(n.properties.variant),
                    ...
                    (function (e) {
                      function t(t) {
                        ...
                        if (
                          n &&
                          (n.getAttribute("action") || n.getAttribute("href"))
                        ) {
                      ...
                      I(window, "load", function () {
                        for (var e = 0; e < document.forms.length; e++) {
                          ...
                          n &&
                            n.indexOf("/cart") >= 0 &&
                            I(document.forms[e], "submit", t);
                        }
                        for (e = 0; e < document.links.length; e++) {
                          var r = document.links[e].getAttribute("href");
                          r &&
                            r.indexOf("/checkout") >= 0 &&
                            I(document.links[e], "click", t);
                        }
                      });
                    })(L),
                    (function (e, t, n) {
                      ...
                      (i = "load"),
                        (o = function () {
                          ...
                          r &&
                            r(document).ajaxSuccess(function (r, i, o) {
                              return A(0, i, o, n, t, e);
                            });
                        }),
                        (r = window).addEventListener
                          ? r.addEventListener(i, o)
                          : r.attachEvent && r.attachEvent("onload", o);
                    })(e, L, O);
                }
              })(e);
          })(e),
      ...
      var x,
        ...
        $ = function (e) {
          "hidden" === document.visibilityState &&
            F > -1 &&
            ((F = "visibilitychange" === e.type ? e.timeStamp : 0), X());
        },
        Q = function () {
                  ...
                  e.forEach(function (e) {
                    "first-contentful-paint" === e.name &&
                      ...
                      e.startTime < r.firstHiddenTime &&
                        ((i.value = Math.max(e.startTime - B(), 0)),
                        i.entries.push(e),
                        n(!0)));
                  });
                });
              o &&
                ((n = D(e, i, Y, t.reportAllChanges)),
                U(function (r) {
                  (i = M("FCP")),
                    (n = D(e, i, Y, t.reportAllChanges)),
                    G(function () {
        ...
        ie = function (e) {
          e.forEach(function (e) {
            e.interactionId &&
              ((ne = Math.min(ne, e.interactionId)),
              (re = Math.max(re, e.interactionId)),
              (te = re ? (re - ne) / 7 + 1 : 0));
          });
        },
        oe = function () {
          ...
          if (
            ...
            if (n || ce.length < 10 || e.duration > t.latency) {
              ...
              ce.sort(function (e, t) {
                ...
                ce.length > 10 &&
                  ce.splice(10).forEach(function (e) {
        ...
        ye = function (e, t) {
          ...
          ge(function () {
            var i = V();
            i &&
              ((n.value = Math.max(i.responseStart - B(), 0)),
              (n.entries = [i]),
              r(!0),
              U(function () {
      ...
      function be(e) {
        ...
        e.entries,
          ...
          _e.add({ name: n, value: r, rating: i, attribution: t });
      }
      function ke(e) {
      ...
      var we = function () {
        ...
        Ie = function (e, n) {
          ...
          if (r.token) {
            ...
            i.properties &&
              0 !== Object.keys(i.properties).length &&
              (u.identities = i.properties),
        ...
        Ae = function (e, t, n) {
          if (!Te.hrvBeacon) {
            var r = {
                browserName: (s = navigator.userAgent).match(
                  /chrome|chromium|crios/i
                )
                  ? "chrome"
                  : s.match(/firefox|fxios/i)
                  ? "firefox"
                  : s.match(/safari/i)
                  ? "safari"
                  : s.match(/opr\//i)
      ...
      try {
        ...
        Pe || console.error("Haravan web analytics load error, invalid token"),
          Ae(Pe, Le, Oe),
          (Te.clearBeacon = function () {
