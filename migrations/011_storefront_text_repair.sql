-- Storefront text repair (idempotent)
-- - Repair mojibake in categories/products/posts/pages/locations.
-- - Remove duplicated mojibake Q&A rows when a clean sibling exists.
-- - Keep all updates conditional so clean records remain untouched.
