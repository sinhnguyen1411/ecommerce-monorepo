...
const termsHtml =
  "<h2><span style=\"font-size:18px\">ĐIỀU KHOẢN DỊCH VỤ - CÔNG TY TTC</span></h2>" +
  "<h3><span style=\"font-size:18px\">1. Giới thiệu</span></h3>" +
  "<p><span style=\"font-size:18px\">Chào mừng quý khách hàng đến với website chính thức của Công ty TTC.</span></p>" +
  "<p><span style=\"font-size:18px\">Khi truy cập và sử dụng website của chúng tôi, quý khách đồng ý tuân thủ và bị ràng buộc bởi các điều khoản dịch vụ này. Công ty TTC có quyền thay đổi, chỉnh sửa, bổ sung hoặc loại bỏ bất kỳ nội dung nào trong Điều khoản dịch vụ vào bất kỳ thời điểm nào mà không cần thông báo trước. Mọi thay đổi sẽ có hiệu lực ngay khi được đăng tải trên website.</span></p>" +
  ...
  "<p><span style=\"font-size:18px\">Website của Công ty TTC được xây dựng nhằm cung cấp thông tin, giới thiệu sản phẩm và hỗ trợ mua hàng cho quý khách.</span></p>" +
  ...
  "<p><span style=\"font-size:18px\">Khi đăng ký tài khoản hoặc đặt hàng, quý khách đồng ý nhận thông tin từ TTC qua email, bao gồm tin tức sản phẩm, chương trình ưu đãi và các thông tin liên quan. Nếu không muốn nhận email quảng cáo, quý khách có thể hủy đăng ký bất kỳ lúc nào bằng cách nhấp vào đường dẫn \"Hủy đăng ký\" ở cuối mỗi email.</span></p>" +
  "<hr><h3><span style=\"font-size:18px\">3. Chính sách thanh toán an toàn và tiện lợi</span></h3>" +
  "<p><span style=\"font-size:18px\">TTC hỗ trợ nhiều hình thức thanh toán để đảm bảo sự tiện lợi và an toàn cho quý khách. Cụ thể:</span></p>" +
  "<ul><li><p><span style=\"font-size:18px\"><strong>Cách 1:</strong> Thanh toán trực tiếp khi mua hàng tại địa chỉ Công ty TTC.</span></p></li>" +
  "<li><p><span style=\"font-size:18px\"><strong>Cách 2:</strong> Thanh toán khi nhận hàng (COD - giao hàng và thu tiền tận nơi).</span></p></li>" +
  "<li><p><span style=\"font-size:18px\"><strong>Cách 3:</strong> Thanh toán online qua chuyển khoản ngân hàng hoặc các phương thức thanh toán điện tử được TTC hỗ trợ.</span></p></li></ul>" +
  "<p><span style=\"font-size:18px\">TTC cam kết bảo mật tuyệt đối thông tin thanh toán của quý khách hàng và tuân thủ đầy đủ quy định bảo mật dữ liệu theo pháp luật hiện hành.</span></p>";
