...
export const metadata = {
  title: "Hỏi đáp cùng nhà nông | Nông Dược Tam Bố",
  description: "Tổng hợp câu hỏi thường gặp về nông nghiệp hữu cơ và sản phẩm Tam Bố."
};
...
export default async function QnAPage() {
  ...
  const fallbackContent =
    ...
    "<h3>3️⃣ Organic Master là gì?</h3><p><strong>Trả lời:</strong><br>Organic Matter là phân bón hữu cơ cao cấp do Tam Bố phân phối, nhập khẩu trực tiếp từ Nhật Bản. Sản phẩm chứa tới 60% chất hữu cơ (OM), 36% axit fulvic và 26,5% amino acid – giúp cải tạo đất bạc màu, phục hồi cây suy yếu và tăng năng suất vượt trội, phù hợp hoàn hảo với mô hình nông nghiệp hữu cơ.</p><hr>" +
    ...
    "<h3>1️⃣5️⃣ Có thể kết hợp Organic Master với phân hóa học không?</h3><p><strong>Trả lời:</strong><br>Hoàn toàn có thể, nhưng để đạt hiệu quả tối ưu và an toàn, Tam Bố khuyến khích bà con ưu tiên sử dụng hữu cơ để nuôi dưỡng đất lâu dài.</p><hr>" +
    ...
    "<h3>1️⃣7️⃣ Organic Matter có giúp tăng năng suất không?</h3><p><strong>Trả lời:</strong><br>Có. Tam Bố cam kết sản phẩm giúp tăng năng suất cây trồng tới 40% khi sử dụng đều đặn và đúng kỹ thuật.</p><hr>" +
    ...
    "<h3>1️⃣9️⃣ Tam Bố có hỗ trợ kỹ thuật cho nông dân không?</h3><p><strong>Trả lời:</strong><br>Có. Tam Bố luôn đồng hành với bà con qua các buổi tập huấn, hướng dẫn kỹ thuật và tư vấn trực tuyến miễn phí.</p>";
